...
Inimigo::Inimigo() //Funciona sem "Player::"??
{
	...
	points_base[0] = glm::vec3( 15.0f,   15.0f , 1.0f);
        points_base[1] = glm::vec3( 15.0f,  30.0f , 1.0f);
        points_base[2] = glm::vec3( 30.0f,  30.0f , 1.0f) ;
	points_base[3] = glm::vec3( 30.0f,  15.0f , 1.0f) ;
...
//---------------------------------------------------------------------
void Inimigo::update(int key)
{

}

//---------------------------------------------------------------------
void Inimigo::colision(int x, int y)
{
